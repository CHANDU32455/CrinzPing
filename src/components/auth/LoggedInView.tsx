...
function LoggedInView({
  ...
  const userProfilePic = crinzData.user.profilePic;
  const userDisplayName = crinzData.userName;
  const userTagline = crinzData.user.tagline;
    ...
    <div style={{ width: "100%", maxWidth: "600px", margin: "1rem auto", padding: "0 1rem" }}>
      <div className="crinz-post" style={{
        ...
        <div className="post-actions" style={{
          ...
          >
            <LikeIcon filled={crinzData.isLiked} />
      ...
      {commentModal && (
        <CommentModal
          ...
          onNewComment={() => onCommentUpdate(crinzData.commentCount + 1)}
          onDeleteComment={() => onCommentUpdate(Math.max(0, crinzData.commentCount - 1))}
        />
      )}
      ...
      <div style={{
        ...
        <div style={{ height: "1px", width: "100px", background: "linear-gradient(90deg, transparent, #00ffcc)" }}></div>
        <span style={{ color: "#00ffcc", fontSize: "0.8rem", letterSpacing: "2px", textTransform: "uppercase" }}>For You</span>
        <div style={{ height: "1px", width: "100px", background: "linear-gradient(90deg, #00ffcc, transparent)" }}></div>
      </div>
