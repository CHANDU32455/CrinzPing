...
import { useAudioPlayer, useMediaManager } from '../feed/tabs/personalizedfeed/Parts/useMediaManager';
import ProfilePicture from './ProfilePicture';
import ImageCarousel from '../feed/tabs/personalizedfeed/Parts/ImageCarousel';
...
const PostTile: React.FC<PostTileProps> = ({ item, onComment, onShare }) => {
